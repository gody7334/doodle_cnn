...
class DecayScheduler():
    def __init__(self, base_lr, decay, step, min_lr):
...
if __name__ == '__main__':
    ...
    scheduler = DecayScheduler(base_lr=0.001, decay=0.9, step=100000, min_lr=0.0001)
    ...
    # scheduler = CyclicScheduler1()
    # scheduler  = CyclicScheduler(min_lr=0.0001,max_lr = 0.001, period=100000)
